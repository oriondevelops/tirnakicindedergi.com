...
const navigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/tirnakicindedergi',
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/tirnakicindedergi/',
            icon: defineComponent({
                render: () =>
                    h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
                        h('path', {
        ...
        {
            name: 'Twitter',
            href: 'https://twitter.com/tirnakicindedrg',
            icon: defineComponent({
                render: () =>
                    h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
                        h('path', {
...
<template>
    <footer class="divide-y-[5px]" aria-labelledby="footer-heading">
        ...
        <div class="pt-4 pb-6 px-6 md:pb-2 md:px-2.5">
            <div class="2xl:grid 2xl:grid-cols-3 2xl:gap-8  ">
                ...
                <!--<div class="mt-12 grid grid-cols-2 gap-8 2xl:mt-0 2xl:col-span-2">
