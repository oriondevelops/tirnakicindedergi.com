                                        ...
                                        <div class="space-y-5">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span class="text-gray-900 text-sm font-medium">Created on <time
                                                    datetime="2020-12-02">Dec 2, 2020</time></span>
                                            </div>
                                        </div>
                        ...
                        <aside class="sticky top-10 h-1 hidden xl:block xl:pl-8">
                            ...
                            <div class="space-y-5">
                                <div v-if="true" class="flex items-center space-x-2">
                                    <LockOpenIcon class="h-5 w-5 text-green-500" aria-hidden="true"/>
                                    <span class="text-green-700 text-sm font-medium">Çizim</span>
                                </div>
                                <div v-if="content" class="flex items-center space-x-2" title="Okuma Süresi">
                                    ...
                                    <span class="text-gray-900 text-sm font-medium">{{ readingTime(content) }} dakika</span>
                                </div>
