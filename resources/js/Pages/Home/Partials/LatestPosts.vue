<template>
    <div class="mt-6 pt-10 grid gap-16 lg:grid-cols-2 lg:gap-x-5 lg:gap-y-12">
        <div v-for="post in posts" :key="post.title" class="hover:p-6 hover:border-l-4 border-primary-400 hover:bg-gray-50 hover:rounded-3xl duration-[2066ms]">
            ...
            <a :href="route('single', post.slug)" class="mt-2 block">
            ...
            <div class="mt-3">
                <a :href="route('single', post.slug)" class="text-sm font-semibold text-primary-600 hover:text-primary-500"> Devamını
                    oku </a>
            </div>
        </div>
    </div>
